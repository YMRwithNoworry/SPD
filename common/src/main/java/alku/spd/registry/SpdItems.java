...
public final class SpdItems {
    ...
    public static final RegistrySupplier<Item> GRIEF_ERODED_DIRT = ITEMS.register("grief_eroded_dirt", () ->
            new BlockItem(SpdBlocks.GRIEF_ERODED_DIRT.get(), new Item.Properties()));
